...
namespace BudgetApp.Migrations
{
    ...
    [Migration("20241020021841_ModifyInitialModels")]
    partial class ModifyInitialModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BudgetApp.Models.CoreModels.ApplicationUser", b =>
                {
                    ...
                    b.Property<decimal>("AccountsBalance")
            ...
            modelBuilder.Entity("BudgetApp.Models.CoreModels.BudgetItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BudgetApp.Models.CoreModels.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BudgetApp.Models.CoreModels.BudgetItem", b =>
                {
                    ...
                    b.HasOne("BudgetApp.Models.CoreModels.ApplicationUser", "User")
                        .WithMany("Expenses")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BudgetApp.Models.CoreModels.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
